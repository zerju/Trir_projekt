...
public class Search {
    ...
    public ArrayList<Game> search(@RequestParam(value = "search") String gameResource) {
        return getSearch(gameResource);
    }

    ArrayList<Game> getSearch(String gameResource) {
